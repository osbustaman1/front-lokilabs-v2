...
export const TextEditorEdit = ({ data }) => {
    ...
    const handleSave =  async() => {
        ...
        const { updateDataApi } = useFech({ url: `contract-type/${id_contract}/${company}/` });
    ...
    useEffect(() => {
        setContractName(data?.ct_contractname || '');
        setTypeContract(data?.ct_typecontract || '');
        setContractCode(data?.ct_contractcode || '');
        editor.commands.setContent(data?.ct_contract || '');
    }, [data]);
                                    ...
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-4 mb-3">
                                            <Select
                                                ...
                                                value={listTypeContract.find((option) => option.value === typeContract) || null}
                                            />
                                            {errors.typeContract && <div className="text-danger">{errors.typeContract}</div>}
                                        </div>
                                    </div>
